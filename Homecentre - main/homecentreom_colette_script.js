...
// var countryName = "window.LMS.pageData.countryIsoCode";
  ...
  var hbTitle = { "curve": "لوح رأسي كيرف", 
                  "ray": "لوح رأسي راي", 
                  "straight": "لوح رأسي سترايت", 
                  "stripe": "لوح رأسي سترايب", 
                  "wing": "لوح رأسي وينج" };
  var baseTitle = { "base-drawer": { "en": "Base with storage", "ar": "مع تخزين" }, 
                    "only-base": { "en": "Base without storage", "ar": "بدون تخزين" } };
